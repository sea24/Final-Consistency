...
{
    /**
     * @Reference(pool="order.pool", fallback="getList")
     *
     * @var UserInterface
     */
    private $userService;
    ...
    public function getList(): array
    {
        ...
        $result = $this->userService->getList(1, 'message');
        //$result = $this->userService->orderUpdate(1);
        /*if ($result['status']) {
            $message = $this->userService2->getList(1, 'message');
        }*/
        return [$result];
    }
